...
pub trait Unsigned: PartialEq + Ord + PartialOrd {}
impl_trait!(impl Unsigned for usize u8 u16 u32 u64 u128);
pub trait Signed: PartialEq + Ord + PartialOrd {}
